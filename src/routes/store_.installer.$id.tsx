...
export const Route = createFileRoute("/store_/installer/$id")({ component: StoreEditInstallerPage });
...
function StoreEditInstallerPage() {
  ...
  if (!partner) {
    return (
      <div className="flex flex-col items-center justify-center py-24 gap-3">
        ...
        <button
          onClick={() => navigate({ to: "/store", search: { tab: "installer" } })}
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      navigate({ to: "/store", search: { tab: "installer" } });
    } catch {
