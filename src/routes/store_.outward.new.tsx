...
export const Route = createFileRoute("/store_/outward/new")({ component: StoreNewOutwardPage });
...
function StoreNewOutwardPage() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      navigate({ to: "/store", search: { tab: "outward" } });
    } catch (e) {
