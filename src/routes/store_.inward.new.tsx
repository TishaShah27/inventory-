...
export const Route = createFileRoute("/store_/inward/new")({ component: StoreNewInwardPage });
...
function StoreNewInwardPage() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      navigate({ to: "/store", search: { tab: "inward" } });
    } catch (e) {
