...
export const Route = createFileRoute("/store_/installer/add")({ component: AddInstallerPage });
...
function AddInstallerPage() {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.22 }}
      ...
      <PageHeader
        eyebrow="Store / Seller"
        title="Add Seller"
        description="Add a new seller partner to the inventory."
        actions={
          <button onClick={() => navigate({ to: "/store", search: { tab: "installer" } })}
