                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-1.5">
                      <button
                        onClick={() =>
                          navigate({ to: "/store/outward/$id", params: { id: m.id } })
                        }
                        title="View details"
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <button
                      onClick={() =>
                        navigate({ to: "/store/inward/$id", params: { id: m.id } })
                      }
                      title="View details"
                      className="grid h-8 w-8 place-items-center rounded-lg border bg-card text-muted-foreground hover:bg-primary-soft hover:text-primary hover:border-primary/30 transition-colors"
                    >
          ...
          >
            ...
            {activeTab === "inward" && (
              <MovementsTab
                ...
                groups={groups}
                masters={masters}
                onNewInward={() => navigate({ to: "/store/inward/new" })}
                inwardEntries={inwardEntries}
              />
            )}
            {activeTab === "outward" && (
              <OutwardTab
                ...
                groups={groups}
                masters={masters}
                onNewOutward={() => navigate({ to: "/store/outward/new" })}
            ...
            {activeTab === "b2b" && (
              <B2bTab
                ...
                onAdd={() => navigate({ to: "/store/b2b/add" })}
                onEdit={(p) => navigate({ to: "/store/b2b/$id", params: { id: p.id } })}
            ...
            {activeTab === "installer" && (
              <InstallerTab
                ...
                onAdd={() => navigate({ to: "/store/installer/add" })}
                onEdit={(p) => navigate({ to: "/store/installer/$id", params: { id: p.id } })}
